...
public class TimeLogic {
	...
	public int checkHour(int hour) {// проверка допустимости значений
		if (hour > 24) {
			return 0;
		}
		return hour;
	...
	public int checkMinute(int minute) {// проверка допустимости значений
		if (minute > 59) {
			return 0;
		}
		return minute;
	...
	public int checkSecond(int second) {// проверка допустимости значений
		if (second > 59) {
			return 0;
		}
		return second;
